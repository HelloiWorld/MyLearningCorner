...
### 系统设置
##### GitHub设置
如果项目是私有项目，或是使用github轮询，需要添加GitHub Server及许可证
...
如果出现***Failed to send out email javax.mail.AuthenticationFailedException: 535 Error: authentication failed, system busy***错误，在确保邮箱已开启SMTP服务情况下，请保证**Extended E-mail Notification**与**邮件通知**两者的配置是一致的，并检查密码，反正我修改Jenkins URL并改改回来此问题就好了......
...
以下是我fastlane关于pgy这个action的代码(我的fastlane已通过`match`自动配置证书，关于这个命令的使用可以查看[match文档](https://docs.fastlane.tools/actions/match/))
...
所以现在本地只能手动点构建或者是采用定时构建方式，在开机后启用
